...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            <img src="{{ asset('assets/images/logo.jpg') }}" alt="Logo" width="50" height="40" class="me-2">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('question.store') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="pertanyaan" rows="4" rows="4">{{ old('pertanyaan') }}</textarea>
                            </div>
